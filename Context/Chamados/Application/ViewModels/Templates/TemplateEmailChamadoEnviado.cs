namespace Chamados.Application.ViewModels.Templates
{
    /// <summary>
    ///
    /// </summary>
    public static class TemplateEmailChamadoEnviado
    {
        /// <summary>
        ///
        /// </summary>
...
<head>
	<title> Chamado Enviado - NORIS </title>
	<!--[if !mso]><!-- -->
...
<body style='background-color:#F4F5FB;'>
    ...
    <![endif]-->
									...
									<tr>
										<td align='left' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
											<div
												...
												<p>Chamado <a href='[URL_DETALHE_CHAMADO][ID_CHAMADO]' target='_blank'
																		style='color: #0078be; text-decoration: none; font-weight: 500;'>
																		<b>[CHAMADO]</b>
																	</a> referente a <b>[SERVICO]</b> aberto com sucesso.</p>
											</div>
										</td>
									</tr>
								</table>
											...
											<table cellpadding='0' cellspacing='0' width='100%' border='0'
												...
												<tr>
													<th colspan='3'
														...
														align='center'>Detalhamento</th>
												</tr>
												<tr>
													<td
														style='font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; width: 30%; padding-top: 10px;'
														width='60%'> Classificação </td>
													<td
														style='font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; text-align: right; width: 20%;'
														width='20%' align='right'>[CLASSIFICACAO]</td>
												</tr>
												<tr>
													<td style='font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal;'> Máquina
													</td>
													<td
														style='font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; text-align: right; padding: 0 0 10px; '
														align='right'>[MAQUINA]</td>
												</tr>
												<tr>
													<td style='font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; '>
														Descrição
													</td>
													<td
														style='font-size: 15px; line-height: 22px; font-weight: 400; word-break: normal; text-align: right; padding: 0 0 10px; width: 100%;'
														align='right'>[DESCRICAO]</td>
												</tr>
											</table>
										</td>
									</tr>
      ...
      >
        <tr>
          <td style='line-height:0px;font-size:0px;mso-line-height-rule:exactly;'>
      <![endif]-->
		<div style='background:#fff;background-color:#fff;margin:0px auto;border-radius:20px;max-width:600px;'>
			<table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation'
				style='background:#fff;background-color:#fff;width:100%;border-radius:20px;'>
				<tbody>
					<tr>
						<td style='direction:ltr;font-size:0px;padding:20px 0;text-align:center;'>
							<!--[if mso | IE]>
									...
									<tr>
										<td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
											<div
												...
												Atenciosamente,<br>Equipe de suporte Noris</div>
										</td>
									</tr>
									<tr>
										<td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
												...
												<tr>
													<td style='padding:4px;'>
														<table border='0' cellpadding='0' cellspacing='0' role='presentation'
															style='border-radius:3px;width:84px;'>
															<tr>
																<td style='font-size:0;height:84px;vertical-align:middle;width:84px;'>
																	<a href='#' target='_blank'
																		style='color: #0078be; text-decoration: none; font-weight: 500;'>
																		<img alt='noris-logo' src='[UrlAssetsForTemplates]/logo_noris.jpg'
																			style='border-radius:3px;display:block;' width='84' title='Noris Logo'>
																	</a>
																</td>
															</tr>
														</table>
    ...
    <![endif]-->
      ...
      <![endif]-->
        ...
        ///
        /// </summary>
        public static string Corpo { get => corpo; set => corpo = value; }
    }
}