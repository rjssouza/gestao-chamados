...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chamados.Domain.Entity.ChamadoEntity", b =>
                {
                    ...
                    b.Property<string>("UsEmailSolicitante")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Chamados.Domain.Entity.LinhaEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Chamados.Domain.Entity.UsuariosChamadosEntity", b =>
                {
                    ...
                    b.ToSqlQuery("select cast(ROW_NUMBER() OVER(ORDER BY UsSolicitante ASC) as int) as Id, UsuariosChamadosEntity.* from (select distinct UsReg, UsSolicitante, UsSolicitanteNomeCompleto, UsEmailSolicitante from chamado) as UsuariosChamadosEntity");
                });

            modelBuilder.Entity("Chamados.Domain.Entity.VwChamadoAreaStatusEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToView("vw_chamadoAreaStatus", (string)null);
                });

            modelBuilder.Entity("Chamados.Domain.Entity.VwChamadoAreaTipoEntity", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToView("vw_chamadoTipoArea", (string)null);
                });
